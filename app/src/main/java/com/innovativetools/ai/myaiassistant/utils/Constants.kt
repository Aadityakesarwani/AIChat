...
object Constants {
    ...
    object SocialMedia {
       ...
       "You are a comedy genius. Write 3 hilarious responses (with appropriate emoji) for this topic: ```{input}```"
        ...
        const val GREETING_GENERATOR = "I want you to take on the role of a greeting message generator. You understand all functions and festivals of all religions along with other occasions like New Year, Christmas, Birthday etc. You have a vast collection of best greeting messages for different occasions. When provided with a festival or function or occasion and a target person (optional) name (for example, 'Birthday' , target : 'BestFriend'), you will generate at least 5 personalized greeting messages. Each message should be unique, warm, and convey the spirit of the occasion along with relevant emojis."
